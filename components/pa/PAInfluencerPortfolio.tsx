                                        ...
                                        <div className="p-8 space-y-8 bg-slate-50/30">
                                            <div className="space-y-4">
                                                ...
                                                <div className="grid grid-cols-1 gap-3">
                                                    ...
                                                    {rawLinksHistory.length === 0 && (
                                                        <div className="p-4 text-slate-400 text-[10px] font-black uppercase text-center border-2 border-dashed border-slate-100 rounded-2xl">No Footage Found</div>
                                                    )}
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                <span className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em] flex items-center gap-3">
                                                    <CheckCircle2 className="w-5 h-5" /> Live Outputs ({editedLinksHistory.length})
                                                </span>
                                                <div className="grid grid-cols-1 gap-3">
