      ...
      <div className="grid gap-3 text-slate-800 sm:grid-cols-[2fr_1.5fr_1fr_1fr_1fr] sm:items-center">
        ...
        <div className="sm:col-span-1">
          ...
          {row.instagram_handle ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-0.5 inline-flex items-center gap-1.5 text-sm font-semibold text-slate-700 transition hover:text-slate-900"
            >
              <Instagram className="h-3.5 w-3.5 text-pink-500" />
              {row.instagram_handle}
            </a>
          ) : (
            <p className="mt-0.5 text-sm font-semibold text-slate-500">—</p>
          )}
        </div>
        ...
        <div className="relative sm:col-span-1">
          ...
          <button
            ...
            className="mt-0.5 inline-flex min-w-[9rem] items-center justify-between gap-2 rounded-3xl border border-slate-200 bg-slate-50 px-4 py-1.5 text-sm font-semibold text-slate-900 transition hover:border-slate-300 hover:bg-slate-100"
          >
