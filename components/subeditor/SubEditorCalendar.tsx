              ...
              >
                ...
                <div className="w-full space-y-0.5 overflow-hidden">
                  {dayProjects.slice(0, 3).map(project => (
                    <div key={project.id} className="bg-purple-600 text-[7px] text-white px-1 py-0.5 rounded font-black uppercase truncate w-full text-center">
                      {project.title}
                    </div>
                  ))}
                  {dayProjects.length > 3 && (
                    <div className="text-[8px] text-purple-600 font-black text-center pt-0.5 border-t border-dashed border-purple-200">
          ...
          >
            ...
            <div className="p-4 max-h-[60vh] overflow-y-auto space-y-3 bg-slate-50">
              {selectedDay.projects.map(project => (
                <div
                  key={project.id}
                  className="p-4 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col gap-2 bg-purple-50"
                >
                  <div className="flex justify-between items-start">
                    <span className="text-[10px] font-black uppercase px-2 py-0.5 border-2 border-purple-600 bg-purple-600 text-white rounded">
                      Delivery
                    </span>
