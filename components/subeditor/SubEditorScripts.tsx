...
const SubEditorScripts: React.FC<Props> = ({ project: initialProject, userRole, onBack }) => {
  ...
  const handleSaveCinematographyInfo = async () => {
    try {
      ...
      alert('Cinematography information updated successfully!');
    } catch (error) {
      console.error('Failed to update cinematography information:', error);
      alert('Failed to update cinematography information. Please try again.');
    }
  };
          ...
          <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  value={cinematographyInstructions}
                  onChange={(e) => setCinematographyInstructions(e.target.value)}
...
export default SubEditorScripts;