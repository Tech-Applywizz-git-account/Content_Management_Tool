...
const DesignerMyWork: React.FC<Props> = ({ user, projects, scriptProjects, onSelectProject, activeFilter, completedSubTab, onSetCompletedSubTab }) => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            {/* Sub-tabs for DELIVERED filter */}
            {activeFilter === 'DELIVERED' && onSetCompletedSubTab && (
