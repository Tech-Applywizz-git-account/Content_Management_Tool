            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 md:p-4 border-2 border-black bg-white focus:outline-none focus:ring-2 focus:ring-black font-bold min-h-[100px] resize-none text-sm md:text-base placeholder:text-slate-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all"
                  placeholder="Describe the creative assets or project requirements..."
                />
              </div>

              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Creative Link *</label>
                ...
                {isLinkSaved && (
                  <div className="flex items-center gap-2 mt-3 animate-fade-in-down">
                      ...
                      <p className="text-[10px] font-black uppercase text-green-600 tracking-wider">Creative link confirmed and saved</p>
                  </div>
                )}
              </div>
              ...
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Content Type *</label>
                <div className="grid grid-cols-2 gap-4">
                  <button
                    onClick={() => setContentType('VIDEO')}
                    className={`p-4 text-center text-xs font-black uppercase border-2 border-black transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] ${contentType === 'VIDEO' ? 'bg-black text-white' : 'bg-white hover:bg-slate-50'}`}
                  >
                    Video
                  </button>
                  <button
                    onClick={() => setContentType('CREATIVE_ONLY')}
                    className={`p-4 text-center text-xs font-black uppercase border-2 border-black transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] ${contentType === 'CREATIVE_ONLY' ? 'bg-black text-white' : 'bg-white hover:bg-slate-50'}`}
                  >
                    Creative Only
                  </button>
                </div>
