            ...
            <aside className="hidden md:flex flex-col w-72 bg-white border-r-2 border-black shadow-[4px_0px_0px_0px_rgba(0,0,0,0.05)] z-10">
                ...
                <div className="flex-1 px-6 py-8 space-y-6 overflow-y-auto">
                    <div className="space-y-3">
                        <button
                            onClick={() => navigate('/editor')}
                            className="w-full flex items-center space-x-3 px-4 py-4 border-2 border-black font-black uppercase transition-transform hover:-translate-y-1 hover:-translate-x-1 bg-white text-black hover:bg-slate-50"
                        >
                        ...
                        <button
                            onClick={() => navigate('/editor/mywork')}
                            className="w-full flex items-center space-x-3 px-4 py-4 border-2 font-bold uppercase transition-all bg-white text-black border-transparent hover:border-black hover:bg-slate-50"
                        >
                ...
                <div className="p-6 border-t-2 border-black bg-slate-50">
                    <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div className="flex-1 overflow-hidden">
                            <p className="text-sm font-black uppercase truncate">Editor</p>
                        </div>
                    </div>
                    <button
                        onClick={onLogout}
