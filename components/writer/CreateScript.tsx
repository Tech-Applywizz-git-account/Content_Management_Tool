        ...
        <div className="grid grid-cols-3 gap-2">
          {Object.values(Channel).map(c => (
            <button
              ...
              className={`p-2 text-[10px] font-black uppercase border-2 border-black ${
                newProjectDetails.channel === c
                  ? 'bg-black text-white'
      ...
      <div className={`${!newProjectDetails.contentType ? 'border-l-4 border-red-500 pl-3 -ml-3' : ''}`}>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className={`p-3 text-xs font-black uppercase border-2 border-black ${
              newProjectDetails.contentType === 'CREATIVE_ONLY'
        ...
        <div className={`${formData.thumbnail_required === undefined ? 'border-l-4 border-red-500 pl-3 -ml-3' : ''}`}>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className={`p-3 text-xs font-black uppercase border-2 border-black ${
                formData.thumbnail_required === false
                  ? 'bg-black text-white'
                  : 'bg-white hover:bg-slate-50'
              }`}
            >
        ...
        <div className="grid grid-cols-3 gap-2">
          {(['LOW', 'NORMAL', 'HIGH'] as const).map(p => (
            <button
              ...
              className={`p-2 text-xs font-black uppercase border-2 border-black ${
                newProjectDetails.priority === p
                  ? 'bg-black text-white'
                  : 'bg-white hover:bg-slate-50'
              }`}
            >
